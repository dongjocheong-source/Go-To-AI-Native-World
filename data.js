 ...
 // ── D00 ────────────────────────────────────────────────────────────
  ...
  // ── F00 ────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: "f03", title: "Skill 활용", meta: "F03", hue: 40,
        body: "유용한 Skill들 및 설명을 제공하기 위한 용도 입니다." },
      { id: "f04", title: "MCP 활용", meta: "F04", hue: 40,
        body: "유용한 MCP들 및 설명을 제공하기 위한 용도 입니다." },
      { id: "f05", title: "컨넥터 활용", meta: "F05", hue: 40,
  ...
  // ── I00 ────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: "i06", title: "ANN-guide", meta: "I06", hue: 320,
        skipGenerate: true,
        body: "로지스틱 회귀 (Logistic Regression) 완벽 가이드." },
      { id: "i07", title: "Deep-learning-guide", meta: "I07", hue: 320,
        skipGenerate: true,
        body: "Feature Engineering이란?" },
      { id: "i08", title: "ANN-guide", meta: "I08", hue: 320,
        body: "KNN (K-Nearest Neighbors) 완벽 가이드." },
      { id: "i09", title: "Deep-learning-guide", meta: "I09", hue: 320,
        body: "나이브 베이즈 (Naive Bayes) 완벽 가이드." },
      { id: "i10", title: "ANN-guide", meta: "I10", hue: 320,
        body: "SVM (Support Vector Machine) 완벽 가이드." },
      { id: "i11", title: "Deep-learning-guide", meta: "I11", hue: 320,
        body: "랜덤 포레스트(Random Forest) 완벽 가이드." },
      { id: "i12", title: "ANN-guide", meta: "I12", hue: 320,
        body: "Gradient Boosting(GBM) 완벽 가이드." },
      { id: "i13", title: "Deep-learning-guide", meta: "I13", hue: 320,
        body: "XGBoost (eXtreme Gradient Boosting) 완벽 가이드" },
      { id: "i14", title: "ANN-guide", meta: "I14", hue: 320,
        body: "LightGBM 완벽 가이드." },
      { id: "i15", title: "Deep-learning-guide", meta: "I15", hue: 320,
        body: "CatBoost 완벽 가이드." },
      { id: "i16", title: "ANN-guide", meta: "I16", hue: 320,
        body: "Python Pickle이란 무엇일까." },
      { id: "i17", title: "Deep-learning-guide", meta: "I17", hue: 320,
        body: "강화 학습(Reinforcement Learning) 파헤쳐보기." },
      { id: "i18", title: "ANN-guide", meta: "I18", hue: 320,
        body: "머신러닝(Machine Learning)이란 무엇일까 ." },
      { id: "i19", title: "Deep-learning-guide", meta: "I19", hue: 320,
        body: "비지도 학습(Unsupervised Learning) 파헤쳐 보기." },
      { id: "i20", title: "ANN-guide", meta: "I20", hue: 320,
        body: "의사결정 나무 (Decision Tree) 완벽 가이드." },
      { id: "i21", title: "Deep-learning-guide", meta: "I21", hue: 320,
        body: "준지도 학습 (Semi-Supervised Learning) 파헤쳐 보기." },
      { id: "i22", title: "ANN-guide", meta: "I22", hue: 320,
      ...
      { id: "i26", title: "Hyperparameter-Tuning-Guide", meta: "I26", hue: 320,
...
// ── P00 ────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { id: "p01", title: "On-Premise LLM", meta: "P01", hue: 275,
        body: "On-Premise LLM에 대한 내용을 준비 중입니다." },
      { id: "p02", title: "OnDeviceAI", meta: "P02", hue: 275,
        body: "OnDeviceAI에 대한 내용을 준비 중입니다." },
      { id: "p03", title: "Inference / Reasoning", meta: "P04", hue: 275,
        body: "Inference / Reasoning에 대한 내용을 준비 중입니다." },
      { id: "p04", title: "Inference / Reasoning", meta: "P04", hue: 275,
        body: "Inference / Reasoning에 대한 내용을 준비 중입니다." },
      { id: "p05", title: "자연어이해", meta: "P05", hue: 275,
        body: "자연어이해에 대한 내용을 준비 중입니다." },
      { id: "p06", title: "NLP", meta: "P06", hue: 275,
        body: "NLP에 대한 내용을 준비 중입니다." },
      { id: "p07", title: "On-Premise LLM", meta: "P07", hue: 275,
        body: "On-Premise LLM에 대한 내용을 준비 중입니다." },
      { id: "p08", title: "OnDeviceAI", meta: "P08", hue: 275,
        body: "OnDeviceAI에 대한 내용을 준비 중입니다." },
      { id: "p09", title: "Inference / Reasoning", meta: "P09", hue: 275,
        body: "Inference / Reasoning에 대한 내용을 준비 중입니다." },
      { id: "p10", title: "자연어이해", meta: "P10", hue: 275,
        body: "자연어이해에 대한 내용을 준비 중입니다." },
      { id: "p11", title: "NLP", meta: "P11", hue: 275,
        body: "NLP에 대한 내용을 준비 중입니다." },
      { id: "p12", title: "On-Premise LLM", meta: "P12", hue: 275,
        body: "On-Premise LLM에 대한 내용을 준비 중입니다." },
      { id: "p13", title: "OnDeviceAI", meta: "P13", hue: 275,
        body: "OnDeviceAI에 대한 내용을 준비 중입니다." },
      { id: "p14", title: "Inference / Reasoning", meta: "P14", hue: 275,
        body: "Inference / Reasoning에 대한 내용을 준비 중입니다." },
      { id: "p15", title: "자연어이해", meta: "P15", hue: 275,
        body: "자연어이해에 대한 내용을 준비 중입니다." },
      { id: "p16", title: "NLP", meta: "P16", hue: 275,
        body: "NLP에 대한 내용을 준비 중입니다." },
      { id: "p17", title: "Inference / Reasoning", meta: "P17", hue: 275,
        body: "Inference / Reasoning에 대한 내용을 준비 중입니다." },
      { id: "p18", title: "자연어이해", meta: "P18", hue: 275,
        body: "자연어이해에 대한 내용을 준비 중입니다." },
      { id: "p19", title: "NLP", meta: "P19", hue: 275,
        body: "NLP에 대한 내용을 준비 중입니다." },
    ],
  },
...
// ── Q00 ────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { id: "q01", title: "On-Premise LLM", meta: "Q01", hue: 275,
        body: "API란 무엇일까." },
      { id: "q02", title: "OnDeviceAI", meta: "Q02", hue: 275,
        body: "API 운영 가이드." },
      { id: "q03", title: "Inference / Reasoning", meta: "Q03", hue: 275,
      ...
      { id: "q08", title: "자연어이해", meta: "Q08", hue: 275,
        body: "Prometheus(프로메테우스)에 대해 자세히 알아보자!" },
      { id: "q09", title: "NLP", meta: "Q09", hue: 275,
        body: " Vite(비트)에 대해 자세히 알아보자!" },
      { id: "q10", title: "NodeJS", meta: "Q11", hue: 275,
  ...
  // ── R00 ────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { id: "r01", title: "On-Premise LLM", meta: "R01", hue: 275,
        body: "uv 실전 가이드." },
      { id: "r02", title: "OnDeviceAI", meta: "R02", hue: 275,
        body: "venv, Conda, 그리고 uv." },
      { id: "r03", title: "Inference / Reasoning", meta: "R03", hue: 275,
        body: "파이썬 가상환경(venv) 사용하는 법." },
      { id: "r04", title: "자연어이해", meta: "R04", hue: 275,
        body: "Json-Repair - AI 시대의 망가진 JSON 자동 복구 라이브러리." },
      { id: "r05", title: "NLP", meta: "R05", hue: 275,
        body: "pydantic이란 무엇인가." },
      { id: "r06", title: "Inference / Reasoning", meta: "R06", hue: 275,
        body: "python Poetry에 대해 자세히 알아보자! ." },
      { id: "r07", title: "자연어이해", meta: "R07", hue: 275,
        body: "뮤텍스(Mutex) vs 세마포어(Semaphore) 완벽 정리." },
      { id: "r08", title: "NLP", meta: "R08", hue: 275,
   ...
   // ── S00 ────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { id: "s01", title: "On-Premise LLM", meta: "S01", hue: 275,
        body: "리눅스 관리자의 기본." },
      { id: "s02", title: "OnDeviceAI", meta: "S02", hue: 275,
        body: "리눅스 네트워크와 원격 접속." },
      { id: "s03", title: "Inference / Reasoning", meta: "S03", hue: 275,
        body: "리눅스 명령어." },
      { id: "s04", title: "자연어이해", meta: "S04", hue: 275,
        body: "리눅스 시스템 정보 및 프로세스 관리." },
      { id: "s05", title: "NLP", meta: "S05", hue: 275,
        body: "리눅스 활용 꿀팁." },
      { id: "s06", title: "자연어이해", meta: "S06", hue: 275,
        body: "Screen 사용법 A to Z 정의." },
      { id: "s07", title: "NLP", meta: "S07", hue: 275,
  ...
  // ── T00 ────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: "t06", title: "IT", meta: "T06", hue: 230,
        body: "[Git] GitLab Merge Request 완벽 가이드." },
      { id: "t07", title: "HTTP 외", meta: "T07", hue: 230,
        body: "[GitHub] 로그인 계정 확인 및 변경 방법." },
      { id: "t08", title: "Python", meta: "T08", hue: 230,
        body: "Github] 원격 저장소 연결 및 관리 (git remote)." },
      { id: "t09", title: "Linux", meta: "T09", hue: 230,
        body: "[GitHub] Git 브랜치(Branch) 핵심 가이드." },
      { id: "t10", title: "Git / GitHub", meta: "T10", hue: 230,
